...
const niveauSchema = new mongoose.Schema({
  code: { type: String, required: true }, // L1, L2, L3
  nom: { type: String, required: true },
...
const programmeSchema = new mongoose.Schema({
  departement: { type: String, required: true }, // economie, gestion, droit
  code: { type: String, required: true }, // sciences-eco, monetaire-bancaire, etc.
  nom: { type: String, required: true },
  description: { type: String, required: true },
