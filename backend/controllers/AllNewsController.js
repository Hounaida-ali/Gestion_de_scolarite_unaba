...
const getAllNews = async (req, res) => {
  try {
    const news = await AllNewsModel.find().sort({ date: -1 });
...
// 🗞️ GET — Récupérer une actualité par ID
...
// 🗑️ DELETE — Supprimer une actualité
